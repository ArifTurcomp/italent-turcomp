...
class User(Base):
    ...
    job_status = Column(String(80), nullable=False, default="not_specified")
    offers_free_coaching = Column(Boolean, nullable=False, default=False)
    offers_free_counselling = Column(Boolean, nullable=False, default=False)
    requests_free_coaching = Column(Boolean, nullable=False, default=False)
    requests_free_counselling = Column(Boolean, nullable=False, default=False)
...
class Contact(Base):
    ...
    notes = Column(Text, nullable=True)
    marital_status = Column(String(40), nullable=False, default="single")
    hiring_personality_test = Column(Text, nullable=True)
    department_id = Column(Integer, ForeignKey("departments.id"), nullable=True)
